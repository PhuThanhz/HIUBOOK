<footer id="tg-footer" class="tg-footer tg-haslayout">
                ...
                <div class="tg-threecolumns">
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        <div class="tg-footercol">
                            <strong class="tg-logo"><a href="javascript:void(0);"><img src="images/logoo.jpg"
                                        alt="image description"></a></strong>
                            <ul class="tg-contactinfo">
                                <li>
                                    <i class="icon-apartment"></i>
                                    <address>140/11 Thanh Đa</address>
                                </li>
                                <li>
                            ...
                            <ul class="tg-socialicons">
                                <li class="tg-facebook"><a href="https://www.facebook.com/websitebookstore/"><i
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        <div class="tg-footercol tg-widget tg-widgettopsellingauthors">
                            ...
                            <div class="tg-widgetcontent">
                                <ul>
                                    <li>
                                        <figure><a href="javascript:void(0);"><img style="width:70px;height:70px ; "
                                                    src="images/author/leader.png" alt="image description"></a></figure>
                                        <div class="tg-authornamebooks">
                                            <h4><a href="javascript:void(0);">Huỳnh Thạnh Phú</a></h4>
                                        </div>
                                    </li>
                                </ul>
                            </div>
    ...
    <div class="tg-footerbar">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <span class="tg-copyright">2021 All Rights Create By &copy; ThanhPhu</span>
                </div>
            </div>
        </div>
    </div>
