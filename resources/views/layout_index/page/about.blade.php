                    ...
                    <div class="tg-aboutus">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="tg-aboutusshortcode">
                                ...
                                <div class="tg-description">
                                    <p style="line-height:28px;text-align: justify;">Trang web bookstore là một trong những
                                        nơi uy
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <figure>
                                ...
                                <iframe width="853" height="480" src="https://www.youtube.com/embed/SKVcQnyEIT8"
                                    frameborder="0"
            ...
            <div class="container">
                <div class="row">
                    <div class="tg-successstory">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="tg-sectionhead">
                                <h2><span>Chi nhánh :</span>Hồ Chí Minh</h2>
                            </div>
                            <div id="tg-successslider" class="tg-successslider tg-success owl-carousel">
                                <div class="item">
                                    ...
                                    <div class="tg-successcontent">
                                        ...
                                        <div class="tg-description">
                                            <p style="line-height:24px;text-align: justify;">Nền tảng thương mại BookStore
                                                được xây dựng nhằm cung cấp cho người sử dùng
                                                những trải nghiệm dễ dàng, an toàn và nhanh chóng khi mua sắm trực tuyến
                                                thông qua hệ
                                                thống hỗ trợ thanh toán và vận hành vững mạnh. Chúng tôi có niềm tin mạnh mẽ
                                                rằng trải nghiệm mua sắm trực tuyến phải đơn giản,
                                                dễ dàng và mang đến cảm xúc vui thích. Niềm tin này truyền cảm hứng và thúc
                                                đẩy chúng tôi mỗi ngày tại BookStore.</p>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 col-lg-push-2">
                            <div id="tg-testimonialsslider" class="tg-testimonialsslider tg-testimonials owl-carousel">
                                <div class="item tg-testimonial">
                                    ...
                                    <blockquote><q>Điều hành hệ thống quản lý của Website, liên hệ vói các công ty khác
                                            .</q></blockquote>
                                    <div class="tg-testimonialauthor">
                                        <h3>Huỳnh Thạnh Phú</h3>
                    ...
                    <div id="tg-teamsslider" class="tg-authors tg-authorsslider tg-teamsmember owl-carousel">
                        @foreach ($company as $com)
                            <div class="item tg-author tg-member">
                                <figure><a href="{{ route('product_company', [$com['id']]) }}"><img
                                            style="width:620px;height:220px;"
                                            src="{{ asset('images/companies/' . $com->image) }}"
                                ...
                                <div class="tg-authorcontent">
                                    ...
                                    <ul class="tg-socialicons">
                                        <li class="tg-facebook"><a
                                                href="{{ route('product_company', $com->id) }}">{{ $com->name }} <i
