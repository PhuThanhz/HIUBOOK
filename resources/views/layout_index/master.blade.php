    ...
    <body>
        ...
        <div class="fb-livechat">
            ...
            <div class="fb-widget">
                ...
                <div class="fb-page" data-href="https://www.facebook.com/websitebookstore" data-tabs="messages"
                    data-width="360" data-height="400" data-small-header="true" data-hide-cover="true"
                    data-show-facepile="false"> </div>
                <div class="fb-credit"> <a href="https://hoaky68.com" target="_blank" rel="noopener noreferrer">Book
                        Store</a> </div>
                <div id="fb-root"></div>
            </div><a href="https://m.me/&#039; + link_mobile + &#039;" title="Gửi tin nhắn cho chúng tôi qua Facebook"
                class="ctrlq fb-button" rel="nofollow" target="_blank">
                <div class="bubble-msg">Bạn cần phú hỗ trợ gì không ?</div>
            </a>
        </div>
        <script>
            ...
            function AddCart(id) {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('.total-price').html('(' + Number(response['cart']['totalPrice']).toString().replace(
                            /(\d)(?=(\d{3})+(?!\d))/g, '$1,') + 'VNĐ)');
                        Swal.fire({
                            icon: 'success',
