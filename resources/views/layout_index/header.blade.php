...
<header id="tg-header" class="tg-header tg-haslayout">
                    ...
                    <ul class="tg-addnav">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                ...
                                <em>{{ __('phone') }}: 0375 948 026</em>
                            </a>
                        </li>
                    </ul>
                    <div class="dropdown tg-themedropdown tg-currencydropdown" style="margin-left: 4%">
                        <a href="{!! route('user.language', ['en']) !!}">
                            <span><img src="{{ asset('images/icon/tienganh.png') }}" height="25px"
                                    width="25px"></span>
                        </a>
                        <a href="{!! route('user.language', ['vi']) !!}">
                            <span><img src="{{ asset('images/icon/tiengviet.png') }}" height="25px"
                                    width="25px"></span>
                        </a>
                    </div>
                    @if (Auth::check())
                        ...
                        @else
                            <div style="margin-left:320px " class="dropdown tg-themedropdown tg-currencydropdown">
                                <a href="javascript:" id="tg-currenty" class="tg-btnthemedropdown"
                                ...
                                <ul class="dropdown-menu tg-dropdownmenu" aria-labelledby="tg-currenty">
                                    <li style="list-style-type: none;text-align:center;">
                                        <a href="{{ route('info', Auth::user()->id) }}">
                        ...
                        @endif
                    @else
                        <a style="margin-left:320px;margin-top:5px ;font-size:15px;font-weight: bold" class="tg-btn"
    ...
    <div class="tg-middlecontainer">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <strong class="tg-logo"><a href="{{ route('index') }}"><img width="220px"
                                src="images/bookstore.jpg" alt="image description"></a></strong>
                    <div class="tg-wishlistandcart">
                        <div class="dropdown tg-themedropdown tg-minicartdropdown">
                            <a href="{{ route('cart') }}" id="tg-minicart" class="tg-btn" aria-haspopup="true"
                                aria-expanded="false">
                                <span style=" margin-left:28px;margin-top:11px " class="tg-themebadge quntity">
                                    @if (Session::has('cart'))
                                ...
                                <span style="font-size: 16px" class="total-price">( @if (Session::has('cart'))
                    ...
                    <div class="tg-searchbox" style="margin-top:18px">
                        <form class="tg-formtheme tg-formsearch" role="search" method="get" id="searchform"
                            action="{{ route('search') }}">
                            <fieldset>
                                <input type="text" value="" name="key" id="s"
                                    class="typeahead form-control" placeholder="{{ __('Enter keywords') }}"
                                    autocomplete="off">
                        ...
                        <div id="tg-navigation" class="collapse navbar-collapse tg-navigation">
                            <ul>
                                ...
                                <li style="font-weight: bold" class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu" style="width:280px">
                                        @for ($i = 0; $i < count($product_n); $i++)
                                            <li style="font-weight: bold;font-size: 13px"><a
                                                    href="{{ route('product_type', $types_id[$i]) }}">{{ $types_name[$i] }}
                                                    ({{ $product_n[$i] }})</a>
                                            </li>
                                        @endfor
                                    </ul>
                                <li style="font-weight: bold" class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li style="font-weight: bold;font-size: 13px"><a
                                                href="{{ route('allnew') }}">{{ __('newbook') }}</a>
                                        </li>
                                        <li style="font-weight: bold;font-size: 13px"><a
                                                href="{{ route('allsale') }}">{{ __('salebook') }}</a>
                                        </li>
                                        <li style="font-weight: bold;font-size: 13px"><a
                                                href="{{ route('allhighlights') }}">{{ __('hotbook') }}</a>
                                        </li>
                                    </ul>
                                </li>
                                <li style="font-weight: bold" class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        @foreach ($company as $com)
                                            <li style="font-weight: bold"><a
                                                    href="{{ route('product_company', $com->id) }}">{{ $com->name }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </li>
